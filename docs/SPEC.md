...
| T1 | 6 | `agents/search` · `agents/[email]` · `events` · `events/[id]/replies` · `alliances` · `alliances/[slug]` |
| T2 | 1 | `POST events` |
| T3 | 6 | `me` · `logout` · 4 × `apikey` |
| T4 | 11 | `bootstrap-status` · `setup` · `stats` · `reset-requests` ×2 · `alliances` ×3 · `agent-alliances` ×3 |
